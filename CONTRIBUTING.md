# Contributing to Media Stack Installer
...
## Dev setup
```
# PowerShell scripts only - read the installer before running it
powershell -ExecutionPolicy Bypass -File .\Install-REGTechesMediaStack.ps1   # from an elevated PowerShell
```
